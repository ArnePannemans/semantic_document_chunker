...
try:
    dataset_stream = load_dataset(
        "intertwine-expel/knowledge-base",
        split="train",
        streaming=True,
...
for i in range(len(bin_targets)):
    for doc in bins[i]:
        output_file = output_dir / f"knowledge_base_en_{doc_counter}.txt"
...
print(f"  Files: knowledge_base_en_1.txt to knowledge_base_en_{total_collected}.txt")
